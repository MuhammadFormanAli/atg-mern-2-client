...
const Posts = () => {
    ...
    const handleAddComment = (id) => {
        ...
        axios.put('https://atg-mern2-server-side.vercel.app/comment/', comment)
            .then(res => {
                refetch()
    ...
    const handleLike = (id) => {
        ...
        axios.put('https://atg-mern2-server-side.vercel.app/like', liked)
            .then(res => {
                refetch()
                console.log(res.data)
            })
    ...
    const handleDeletePost = (id) => {
        ...
        axios.delete(`https://atg-mern2-server-side.vercel.app/posts/${id}`)
            .then(res => {
                refetch()
                console.log(res.data)
            })
